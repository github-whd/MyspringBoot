...
public class MyImageController {
	...
	public void inserImg(HttpServletRequest request, HttpServletResponse response,
	...
	public void inserImgFtp(HttpServletRequest request, HttpServletResponse response,
			@RequestParam("img") MultipartFile file) throws IOException {
